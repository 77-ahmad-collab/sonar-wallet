...
declare module "@mui/material/styles/createPalette" {
  interface TypeBackground {
    ...
    Box?: CSSProperties["color"];
    bottomLayout?: CSSProperties["color"];
    darkColor?: CSSProperties["color"];
    swap?: CSSProperties["color"];
    lightGrayish?: CSSProperties["color"];
    walletWrapper?: CSSProperties["color"];
    boxRow?: CSSProperties["color"];
    boxRowHoverColor: CSSProperties["color"];
    tokenChipBox: CSSProperties["color"];
    pink: CSSProperties["color"];
    green: CSSProperties["color"];
    snackbar: string;
    darkColorModal: string;
  }
    ...
    ...(mode === "light"
      ? {
          background: {
            ...
            swap: "#1a1a1a",
            lightGrayish: "#161616",
            walletWrapper: "rgba(255, 255, 255, 0.06)",
            boxRow: "#1b1820",
            boxRowHoverColor: "#242424",
            tokenChipBox: "rgba(255, 255, 255,0.1)",
            pink: "rgba(255, 150, 175, 1)",
            green: "rgba(118, 255, 214, 1)",
            snackbar:
              "linear-gradient(0deg, rgba(255, 255, 255, 0.08), rgba(255, 255, 255, 0.08)), #101017",
            darkColorModal: "#151119",
          },
          text: {
            default: "#fff",
            primary: "#000",
