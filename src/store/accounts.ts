...
import {
  ...
  AddressOnNetwork,
  NameOnNetwork,
} from "../background-related/accounts";
import {
  AnyAsset,
  AnyAssetAmount,
  SmartContractFungibleAsset,
} from "../background-related/assets";
import { normalizeEVMAddress } from "../background-related/lib/utils";
import { EVMNetwork, Network } from "../background-related/networks";
import { SignerType } from "../background-related/services/signing";
import { DomainName, HexString, URI } from "../background-related/types";
...
const accountSlice = createSlice({
  ...
  reducers: {
    loadAccount: (
      ...
      // immerState.accountsData.evm[network.chainID] ??= {};
      // if (!immerState.accountsData.evm[network.chainID])
      //   immerState.accountsData.evm[network.chainID] = {};
