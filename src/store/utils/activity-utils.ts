import { convertToEth, weiToGwei } from "../../background-related/lib/utils";
import { ConfirmedEVMTransaction } from "../../background-related/networks";
import { EnrichedEVMTransaction } from "../../background-related/services/enrichment";
...
export const keysMap: UIAdaptationMap = {
  ...
  value: {
    readableName: "Amount",
    transformer: tx => amountTransformer(tx.value, tx.network.baseAsset.symbol),
  ...
  gasUsed: {
    readableName: "Gas",
    transformer: tx => ("gasUsed" in tx ? toStringTransformer(tx.gasUsed) : ""),
    detailTransformer: tx =>
